...
class _Primary {
  Color original = const Color(0xff003a678);
...
class _Secondary {
  Color original = const Color(0xFFF1D077);
...
class _Dark {
  Color original = const Color(0xFF101720);
...
class _Light {
  Color original = const Color(0xFFF8F8FF);
  Color hard = const Color(0xFFFFFFFF);
}

class Indicator {
  Color original = const Color(0xFFCC0000);
